...
## *!* ## Dabo Code ID: dButton-dPage-81
def onHit(self, evt):
	self.Form.requery()



## *!* ## Dabo Code ID: dButton-dPanel-527
def onHit(self, evt):
	# Save Button
	try:
...
## *!* ## Dabo Code ID: dButton-dPage-923
def onHit(self, evt):
	self.Form.prior()
...
## *!* ## Dabo Code ID: dButton-dPage-408
def onHit(self, evt):
...
## *!* ## Dabo Code ID: dDropdownList-dPanel-183
def afterInit(self):
...
## *!* ## Dabo Code ID: dButton-dPanel-931
def onHit(self, evt):
	# Print Forms button
...
## *!* ## Dabo Code ID: dButton-dPanel-290
def onHit(self, evt):
	# Refresh button
	self.Form.requery()
...
## *!* ## Dabo Code ID: dButton-dPage-950
def onHit(self, evt):
	try:
...
## *!* ## Dabo Code ID: dButton-dPage-854
def onHit(self, evt):
	self.Form.first()



## *!* ## Dabo Code ID: dButton-dPanel-343
def onHit(self, evt):
	self.Form.last()
...
## *!* ## Dabo Code ID: dButton-dPanel-457
def onHit(self, evt):
	self.Form.prior()



## *!* ## Dabo Code ID: dButton-dPage-296
def onHit(self, evt):
	self.Form.last()
...
## *!* ## Dabo Code ID: dButton-dPage-242
def onHit(self, evt):
	self.Form.next()



## *!* ## Dabo Code ID: dButton-dPanel-163
def onHit(self, evt):
	# Grade button
...
## *!* ## Dabo Code ID: dButton-dPanel-707
def onHit(self, evt):
	# Delete grade button
...
## *!* ## Dabo Code ID: dButton-dPanel-141
def onHit(self, evt):
	self.Form.first()
...
## *!* ## Dabo Code ID: dButton-dPanel-729
def onHit(self, evt):
	# Delete button
...
## *!* ## Dabo Code ID: dButton-dPanel-259
def onHit(self, evt):
	# Add grade button
	app = self.Application
