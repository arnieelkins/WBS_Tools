...
class Wbsids(Base):
	...
	def initProperties(self):
		super(Wbsids, self).initProperties()
		self.Caption = "Wbsids"
		...
		self.DataStructure = (
				("RecNo", "I", True, "WBSIDS", "RecNo"),
				("WBSID", "C", False, "WBSIDS", "WBSID"),
				("CongregationName", "C", False, "WBSIDS", "CongregationName"),
		)
