...
class Contacts(Base):
	...
	def initProperties(self):
		super(Contacts, self).initProperties()
		...
		self.DataStructure = (
				("RecNo", "I", True, "Contacts", "RecNo"),
				("WBSIDSRecNo", "I", False, "Contacts", "WBSIDSRecNo"),
				("FirstName", "C", False, "Contacts", "FirstName"),
				("LastName", "C", False, "Contacts", "LastName"),
		)
