...
class Students(Base):
	...
	def initProperties(self):
		super(Students, self).initProperties()
		...
		self.DataStructure = (
				("RecNo", "I", True, "Students", "RecNo"),
				("StudentID", "C", False, "Students", "StudentID"),
				("WBSIDSRecNo", "I", False, "Students", "WBSIDSRecNo"),
				("TeachersRecNo", "I", False, "Students", "TeachersRecNo"),
				("ContactsRecNo", "I", False, "Students", "ContactsRecNo"),
				("FirstName", "C", False, "Students", "FirstName"),
				("LastName", "C", False, "Students", "LastName"),
				("Age", "I", False, "Students", "Age"),
				("Birthdate", "D", False, "Students", "Birthdate"),
				("Gender", "C", False, "Students", "Gender"),
				("MaritalStatus", "C", False, "Students", "MaritalStatus"),
				("Religion", "C", False, "Students", "Religion"),
				("ChurchName", "C", False, "Students", "ChurchName"),
				("WBSBefore", "B", False, "Students", "WBSBefore"),
				("Country", "C", False, "Students", "Country"),
				("State", "C", False, "Students", "State"),
				("City", "C", False, "Students", "City"),
				("PostalAddress", "C", False, "Students", "PostalAddress"),
				("EmailAddress", "C", False, "Students", "EmailAddress"),
				("Phone1", "C", False, "Students", "Phone1"),
				("Phone2", "C", False, "Students", "Phone2"),
				("StreetAddress", "C", False, "Students", "StreetAddress"),
				("Occupation", "C", False, "Students", "Occupation"),
				("HasBeenBaptized", "B", False, "Students", "HasBeenBaptized"),
				("TypeOfBaptism", "C", False, "Students", "TypeOfBaptism"),
				("RequestedBaptism", "B", False, "Students", "RequestedBaptism"),
				("Bible", "B", False, "Students", "Bible"),
				("Notes", "M", False, "Students", "Notes"),
		)
