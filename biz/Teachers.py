...
class Teachers(Base):
	...
	def initProperties(self):
		super(Teachers, self).initProperties()
		...
		self.DataStructure = (
				("RecNo", "I", True, "Teachers", "RecNo"),
				("WBSIDSRecNo", "I", False, "Teachers", "WBSIDSRecNo"),
				("FirstName", "C", False, "Teachers", "FirstName"),
				("LastName", "C", False, "Teachers", "LastName"),
		)
