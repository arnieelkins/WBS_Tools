...
class Grades(Base):
	...
	def initProperties(self):
		super(Grades, self).initProperties()
		self.Caption = "Grades"
		...
		self.DataStructure = (
				("RecNo", "I", True, "Grades", "RecNo"),
				("Date", "D", False, "Grades", "Date"),
				("LessonsRecNo", "I", False, "Grades", "LessonsRecNo"),
				("Score", "I", False, "Grades", "Score"),
				("StudentsRecNo", "I", False, "Grades", "StudentsRecNo"),
		)
